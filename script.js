var planetModal1 = document.getElementById("planetModal1");
var planetModal2 = document.getElementById("planetModal2");
var planetModal3 = document.getElementById("planetModal3");
var planetModal4 = document.getElementById("planetModal4");
var planetModal5 = document.getElementById("planetModal5");

// Get the button that opens the modal
var planetModalButton1 = document.getElementById("planetModalButton1");
var planetModalButton2 = document.getElementById("planetModalButton2");
var planetModalButton3 = document.getElementById("planetModalButton3");
var planetModalButton4 = document.getElementById("planetModalButton4");
var planetModalButton5 = document.getElementById("planetModalButton5");

// Get the <span> element that closes the modal
var planetClose1 = document.getElementById("planetClose1");
var planetClose2 = document.getElementById("planetClose2");
var planetClose3 = document.getElementById("planetClose3");
var planetClose4 = document.getElementById("planetClose4");
var planetClose5 = document.getElementById("planetClose5");
...
function showSlidesAuto() {
  ...
  slides[slideIndex-1].style.display = "block";  
  dots[slideIndex-1].className += " activedot";
  setTimeout(showSlidesAuto, 7500); // Change image every 2 seconds
}

//Sector 1
// When the user clicks the button, open the modal 
planetModalButton1.onclick = function() {
  planetModal1.style.display = "block";
}
// When the user clicks on <span> (x), close the modal
planetClose1.onclick = function() {
  planetModal1.style.display = "none";
}

//Sector 2
// When the user clicks the button, open the modal 
planetModalButton2.onclick = function() {
  planetModal2.style.display = "block";
}
// When the user clicks on <span> (x), close the modal
planetClose2.onclick = function() {
  planetModal2.style.display = "none";
}

//Sector 3
// When the user clicks the button, open the modal 
planetModalButton3.onclick = function() {
  planetModal3.style.display = "block";
}
// When the user clicks on <span> (x), close the modal
planetClose3.onclick = function() {
  planetModal3.style.display = "none";
}

//Sector 4
// When the user clicks the button, open the modal 
planetModalButton4.onclick = function() {
  planetModal4.style.display = "block";
}
// When the user clicks on <span> (x), close the modal
planetClose4.onclick = function() {
  planetModal4.style.display = "none";
}

//Sector 5
// When the user clicks the button, open the modal 
planetModalButton5.onclick = function() {
  planetModal5.style.display = "block";
}
// When the user clicks on <span> (x), close the modal
planetClose5.onclick = function() {
  planetModal5.style.display = "none";
}

// When the user clicks anywhere outside of the modal, close it
window.onclick = function(event) {
  if (event.target == planetModal1) {planetModal1.style.display = "none";}
  else if (event.target == planetModal2) {planetModal2.style.display = 'none';}
  else if (event.target == planetModal3) {planetModal3.style.display = 'none';}
  else if (event.target == planetModal4) {planetModal4.style.display = 'none';}
  else if (event.target == planetModal5) {planetModal5.style.display = 'none';}
}
